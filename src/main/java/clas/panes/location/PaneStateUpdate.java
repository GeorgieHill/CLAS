 ...
 */
public class PaneStateUpdate implements PaneUI {
	...
	private PaneStateEdit editPane;
	private static final String TITLE = "Update States";;
	private static final int VERTICAL_GAP = 15;
	private static final int HORIZ_GAP = 10;
	private static final int MIN_WIDTH = 300;
	private Organization org;

	public PaneStateUpdate(Organization org) {
		...
		//Header label
		label = new Label("Update State Records");
