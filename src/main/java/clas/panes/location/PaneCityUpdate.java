 ...
 */
public class PaneCityUpdate implements PaneUI {
	...
	private PaneCityEdit editPane;
	private static final String TITLE = "Update Cities";;
	private static final int VERTICAL_GAP = 15;
	private static final int HORIZ_GAP = 10;
	private static final int MIN_WIDTH = 300;
	private Organization org;

	public PaneCityUpdate(Organization org) {
		...
		//Header label
		label = new Label("Update City Records");
