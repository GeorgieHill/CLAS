...
public class PaneQualityReport implements PaneUI {
	
	private final String TITLE = "Leadership Quality Report";
	...
	public PaneQualityReport(ObservableList<Quality> data) {
		label = new Label("Leadership Quality Report");
